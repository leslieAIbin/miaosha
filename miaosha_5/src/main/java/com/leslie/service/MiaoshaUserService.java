...
import com.leslie.util.MD5Util;
import com.leslie.util.UUIDUtil;
...
public class MiaoshaUserService {
    ...
    public String login(HttpServletResponse response, LoginVo loginVo) {
        ...
        /**
         *  登录成功之后生成一个TOKEN 标识用户
         *  写到COOKIE  传到客户端
         *  客户端在随后的访问 都在随后的访问中上传cookie
         *  服务端拿到token  来取到session信息
         **/
        //生成cookie
